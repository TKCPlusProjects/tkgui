...
namespace tkht {
namespace tkgui {
void ViewTableSetting::Cell::OnDisplay() {
  ...
  case tkgm::SetItem::Type_Checkbox: {
    shared_ptr<tkgm::CheckboxItem> type_item = dynamic_pointer_cast<tkgm::CheckboxItem>(item);
    ImGui::Checkbox("##Checkbox", &(type_item->value));
    } break;
    
  case tkgm::SetItem::Type_SliderInt: {
    shared_ptr<tkgm::SliderIntItem> type_item = dynamic_pointer_cast<tkgm::SliderIntItem>(item);
    ImGui::SliderInt("##SliderInt", &(type_item->value), type_item->min, type_item->max, "%d");
    } break;
  case tkgm::SetItem::Type_SliderFloat: {
    shared_ptr<tkgm::SliderFloatItem> type_item = dynamic_pointer_cast<tkgm::SliderFloatItem>(item);
    ImGui::SliderFloat("##SliderFloat", &(type_item->value), type_item->min, type_item->max, "%.0f");
    } break;
  case tkgm::SetItem::Type_KeyButton: {
    shared_ptr<tkgm::KeyButtonItem> type_item = dynamic_pointer_cast<tkgm::KeyButtonItem>(item);
